...
const aliquotaImposto = pegarAliquota(vallorSalario);
const valorDoImposto = calcularPorcentagem(vallorSalario, aliquotaImposto);
const valorATransferir = vallorSalario - valorDoImposto + valorBeneficios
